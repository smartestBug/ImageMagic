...
import com.msemyak.dev.imagemagic.activities.add_image.AddImageActivity;
...
public class ImagesListActivity extends AppCompatActivity implements ImagesListContract.View{
    ...
    ImagesListContract.Presenter myPresenter;
    String token;
